  ...
  return (
    <>
      ...
      <section className="py-24 bg-white relative">
        <div className="container px-4 md:px-6 lg:px-8">
          <div className="text-center mb-16 max-w-3xl mx-auto">
            <span className="text-[#d4a843] font-bold text-sm tracking-wider uppercase mb-2 block">حقائق وأرقام</span>
            <h2 className="text-4xl md:text-5xl font-bold text-[#3d4a7b] mb-6">أرقام الإنجاز تتحدث</h2>
      ...
      <section className="py-24 bg-[#f8faf9] border-y border-gray-100">
        <div className="container px-4 md:px-6 lg:px-8">
          <div className="text-center mb-16 max-w-3xl mx-auto">
            <span className="text-[#d4a843] font-bold text-sm tracking-wider uppercase mb-2 block">رؤية للمستقبل</span>
            <h2 className="text-4xl md:text-5xl font-bold text-[#3d4a7b] mb-6">البرنامج الانتخابي</h2>
            <p className="text-gray-600 text-xl leading-relaxed">
          ...
          {/* Vision Statement */}
          <div className="bg-gradient-to-r from-[#3d4a7b] to-[#4d5a8b] rounded-3xl p-10 md:p-12 mb-16 text-white text-center shadow-2xl relative overflow-hidden">
            <div className="absolute top-0 right-0 w-64 h-64 bg-white opacity-5 rounded-full blur-3xl transform translate-x-1/2 -translate-y-1/2"></div>
            <div className="absolute bottom-0 left-0 w-64 h-64 bg-[#d4a843] opacity-10 rounded-full blur-3xl transform -translate-x-1/2 translate-y-1/2"></div>
          ...
          <div className="text-center mt-12">
            <Link
              href="/vision"
              className="inline-flex items-center gap-3 bg-[#3d4a7b] hover:bg-[#2d3a5b] text-white text-lg font-bold py-4 px-10 rounded-xl transition-all shadow-lg hover:shadow-xl hover:-translate-y-1"
            >
        ...
        <div className="container px-4 md:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div className="order-2 lg:order-1">
              <span className="text-[#d4a843] font-bold text-sm tracking-wider uppercase mb-2 block">مسيرة عطاء</span>
              <h2 className="text-4xl md:text-5xl font-bold text-[#3d4a7b] mb-6">إنجازات بارزة</h2>
              ...
              <div className="space-y-6">
                {KEY_ACHIEVEMENTS.slice(0, 5).map((achievement, index) => (
                  <div key={index} className="flex items-start gap-4 p-5 bg-[#f8faf9] rounded-2xl border border-gray-100 hover:border-[#d4a843]/30 transition-colors">
                    <div className="w-10 h-10 bg-[#e8f5e9] text-[#3d4a7b] rounded-full flex items-center justify-center flex-shrink-0 font-bold text-lg shadow-sm">
                      {index + 1}
                    </div>
              ...
              <div className="mt-10">
                <Link
                  href="/achievements"
                  className="inline-flex items-center gap-2 text-[#3d4a7b] text-lg font-bold hover:text-[#d4a843] transition-colors group"
                >
                  <span className="border-b-2 border-transparent group-hover:border-[#d4a843] transition-all">عرض جميع الإنجازات</span>
            ...
            <div className="order-1 lg:order-2 grid grid-cols-2 gap-5 md:gap-6">
              <div className="bg-gradient-to-br from-[#d4a843] to-[#e4b853] rounded-3xl p-8 text-white shadow-xl flex flex-col items-center text-center justify-center aspect-square">
              ...
              <div className="bg-gradient-to-br from-[#3d4a7b] to-[#4d5a8b] rounded-3xl p-8 text-white shadow-xl flex flex-col items-center text-center justify-center aspect-square">
              ...
              <div className="bg-[#f0fdf4] rounded-3xl p-8 text-[#3d4a7b] flex flex-col items-center text-center justify-center aspect-square border border-[#3d4a7b]/10">
                <Users className="w-12 h-12 mb-4 text-[#3d4a7b]" />
      ...
      <section className="py-24 bg-[#f8faf9] border-y border-gray-100">
        <div className="container px-4 md:px-6 lg:px-8">
          <div className="text-center mb-16 max-w-3xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-bold text-[#3d4a7b] mb-6">شراكات وتعاون</h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
            {PARTNERS.slice(0, 8).map((partner, index) => (
              ...
              >
                ...
                <p className="font-bold text-base text-gray-800 group-hover:text-[#3d4a7b] transition-colors">{partner.name}</p>
              </div>
            ))}
          </div>
          ...
          <div className="text-center mt-12">
            <Link
              ...
              className="inline-flex items-center gap-2 text-[#3d4a7b] text-lg font-bold hover:text-[#d4a843] transition-colors group"
            >
              <span className="border-b-2 border-transparent group-hover:border-[#d4a843] transition-all">عرض جميع الشراكات</span>
              <ArrowLeft size={20} className="group-hover:-translate-x-1 transition-transform" />
            </Link>
          </div>
        </div>
        ...
        <div className="container px-4 md:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              <span className="text-[#d4a843] font-bold text-sm tracking-wider uppercase mb-2 block">لأنك تسأل</span>
              <h2 className="text-4xl md:text-5xl font-bold text-[#3d4a7b] mb-6">أسئلة شائعة</h2>
              <p className="text-gray-600 text-xl">إجابات شفافة ومباشرة على استفساراتكم</p>
            </div>

            <div className="space-y-6">
              {FAQ_ITEMS.slice(0, 3).map((item, index) => (
                <div key={index} className="bg-white border border-gray-200 rounded-2xl p-8 hover:border-[#d4a843] transition-colors shadow-sm hover:shadow-md">
                  <h3 className="text-xl font-bold text-[#3d4a7b] mb-4 flex items-start gap-3">
                    <CheckCircle size={24} className="text-[#d4a843] flex-shrink-0 mt-0.5" />
                    {item.question}
                  </h3>
          ...
          <div className="text-center max-w-4xl mx-auto text-white">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-6">
              <a
                ...
                className="inline-flex items-center justify-center gap-3 bg-[#d4a843] hover:bg-[#e4b853] text-white text-xl font-bold py-5 px-12 rounded-2xl transition-all shadow-xl hover:shadow-2xl hover:-translate-y-1"
              >
